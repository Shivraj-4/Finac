...
function CardInfo({ budgetList, incomeList ,investmentList}) {
  ...
  useEffect(() => {
    if (totalBudget > 0 || totalIncome > 0 || totalSpend > 0 || investment > 0) {
  ...
  }, [totalBudget, totalIncome, totalSpend,investment]);
  ...
  const CalculateCardInfo = () => {
    ...
    investmentList.forEach((element) => {
      totalInvestment_ = totalInvestment_+ element.totalInvestment
    })
